                ...
                <form action="/{{$workspace_detail->id}}/reports" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 col-lg-3">
                            ...
                            <select class="form-select" name="q_zone_id"
                                    aria-label="Default select example">
                                <option @if(!isset($searchTerm['q_zone_id'])) selected @endif  disabled>
                                    Bölge
                                    seçiniz...
                                </option>

                                <?php $selectedId = isset($searchTerm['q_zone_id']) ? $searchTerm['q_zone_id'] : null ?>

                                {{printTree($zones,$selectedId)}}
                            </select>
                        ...
                        <div class="row">
                            <div class="col-12 col-md col-lg">
                                ...
                                <select class="form-select" name="q_serial_no"
                                        aria-label="Default select example">
                                    <option @if(!isset($searchTerm['q_serial_no'])) selected
                                            @endif disabled>Cihaz
                                        seçiniz...
                                    </option>
                                    @foreach($allowed_devices as $device)
                                        <option
                                            @if(isset($searchTerm['q_serial_no']) && $searchTerm['q_serial_no'] == $device->serial_no ) selected
                                            @endif value="{{$device->serial_no}}">{{$device->device_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 col-md col-lg">
            ...
            <div class="table-responsive" style="text-align: center;">
                <table id="table" data-show-export="true" data-pagination="true" data-click-to-select="true"
                    ...
                    <tr>
                        ...
                        <th data-sortable="true">Zaman</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    @if(isset($deviceLogs))
                        ...
                        @foreach($deviceLogs->get() as $key => $deviceLog)
                            <tr>
                                ...
                                {{--                                <td>{{turkishDate('j F Y , l',explode(' ',$deviceLog->d_created_at)[0])}}--}}
