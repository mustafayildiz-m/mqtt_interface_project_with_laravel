...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center mb-3 mt-4">Planlar</h2>
            <p class="text-muted text-center mb-4 pb-2">İhtiyacınız olan çözümü seçin, ihtiyaçlarınız büyüdüğünde kolayca
                paket yükseltin.</p>
            <div class="container">
                <div class="row">
                    <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-grid">
                                    <button class="btn btn-primary mt-4">Satın Al</button>
                                </div>
                            </div>
                        </div>
                    </div>
